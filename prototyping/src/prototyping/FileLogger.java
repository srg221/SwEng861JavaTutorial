...
public class FileLogger {
	 ...
	 *            writing the data.
	 */
	public FileLogger(String fileName, char delimiter, Charset charset) {
		if (fileName == null) {
	 ...
	 *            The character to use as the column delimiter.
	 */
	public FileLogger(Writer outputStream, char delimiter) {
	 ...
	 *            writing the data.
	 */
	public FileLogger(OutputStream outputStream, char delimiter, Charset charset) {
