...
public class MediaListExtTag extends ExtTagStream {
	...
	MediaListExtTag(PlayList playList, PlayListScanner scanner, String tagName, String url) throws MalformedURLException{
		super(playList, scanner, tagName, url);
	}
	
	// this one waits for validate to download
	MediaListExtTag(PlayList playList, PlayListScanner scanner, String tagName) throws MalformedURLException{
		super(playList, scanner, tagName);
	}
	
	//public static MediaListExtTag Clone(PlayList playList, PlayListScanner scanner, String tagName, String url) throws MalformedURLException{
	//	MediaListExtTag clone = new MediaListExtTag(playList, scanner, tagName, url);
	//	return clone;
	//}
